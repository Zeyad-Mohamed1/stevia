...
export default function CartModal() {
  ...
  // Get recommended products (first 6 products that are not in cart)
  // const recommendedProducts = allProducts
  //   .filter((product) => !isAddedToCartProducts(product.id))
  //   .slice(0, 6);
    ...
    <div className="modal fullRight fade modal-shopping-cart" id="shoppingCart">
      <div className="modal-dialog">
        <div className="modal-content">
          {/* You May Also Like Section - Commented out and replaced with real data */}
                      ...
                      <div className="content">
                        ...
                        <div className="cart-item-bot">
                          ...
                          <a
                            ...
                            onClick={() =>
                              addProductToCart(product.id, 1, false)
                            }
                          >
          ...
          <div className="d-flex flex-column flex-grow-1 h-100">
            <div className="header">
              <h5 className="title">{t("cart.title")}</h5>
              <span
            ...
            <div className="wrap">
              {/* <div className="tf-mini-cart-threshold">
                ...
                <div className="text-caption-1">{t("cart.freeShipping")}</div>
              </div> */}
                  ...
                  <div className="tf-mini-cart-sroll">
                    {isCartLoading ? (
                      <div className="p-4 text-center">
                        ...
                        <div className="mt-2">{t("cart.loading")}</div>
                      </div>
                    ) : cartProducts?.length ? (
