...
const swiperSlides = [
  ...
  {
    id: 2,
    src: "/images/products/baby/product-1.jpg",
    alt: "",
    color: "gray",
    width: 450,
    height: 450,
  ...
  {
    id: 4,
    src: "/images/products/baby/product-5.jpg",
    alt: "",
    color: "gray",
    width: 615,
    height: 615,
  ...
  {
    id: 5,
    src: "/images/products/baby/product-6.jpg",
    alt: "",
    color: "beige",
    width: 615,
    height: 615,
  ...
  {
    id: 6,
    src: "/images/products/baby/product-7.jpg",
    alt: "",
    color: "beige",
    width: 615,
    height: 615,
...
export default function Details1Special({ product }) {
                  ...
                  <div className="tf-product-info-choose-option">
                    ...
                    <ul className="tf-product-info-sku">
                      ...
                      <li>
                        ...
                        <p className="text-caption-1 text-1">Stevia</p>
                      </li>
                      <li>
